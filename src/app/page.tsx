...
export default function Home() {
  ...
  const computePrice = () => {
    ...
    if (form.values.plan === "mini") price = 1200;
    if (form.values.plan === "mini") price = 1500;

    //check discount here
    if (form.values.hasCoupon && form.values.coupon === "CMU2023") return true;
    return price;
  };
  ...
  return (
    <div>
      <Container size="500px">
        ...
        <Footer year={2024} fullName="Natsathon Phanamphan" studentId="660612145" />
      </Container>
